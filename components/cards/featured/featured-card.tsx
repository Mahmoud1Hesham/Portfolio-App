...
const FeaturedCard:FC<FeaturedCardProps> = ({
    logo,title,tag,video,active })=>{
    return <>
    <div className="link w-full h-full bg-secondary-background border border-border shadow-lg rounded-3xl curser-pointer flex flex-col gap-2 flex-nowrap p-2">
        {/* Header */}
