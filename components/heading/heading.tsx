...
const Heading: FC<HeadingProps> = ({ number, title_1, title_2 }) => {
  return <>
    <div className="relative my-10 px-8 z-20">
      {/* Number */}
      <div className="outline-none flex flex-col justify-start shrink-0 opacity-5 transform -top-32 2xl:-top-20 w-[71px] flex-none h-auto left-4 lg:left-12 absolute whitespace-pre">
        <h2 className="font-pixel text-[180px] text-center text-primary-foreground relative">
          <span className="bg-clip-text text-transparent p-4 bottom-fade">
            {number}
          </span>
        </h2>
      </div>
      ...
      <div className="flex items-center flex-nowrap min-h-min overflow-hidden p-0 w-full font-oswald">
        ...
        <HeadingAnimatedSvg text="Deploying Brilliance Crafting Brilliance"/>
